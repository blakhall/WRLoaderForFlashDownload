...
void FlashTest1()
{
    ...
    // frequency before any other Flash API operation can be performed //F021_CPU0_W0_BASE_ADDRESS

	oReturnCheck = Fapi_initializeAPI(F021_CPU0_W0_BASE_ADDRESS, 200);//for now keeping it out
